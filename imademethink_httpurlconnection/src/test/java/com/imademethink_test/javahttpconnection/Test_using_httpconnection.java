package com.imademethink_test.javahttpconnection;
...
public class Test_using_httpconnection {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Test_using_httpconnection http                                   = new Test_using_httpconnection();
        ...
        http.GET_signup_details(objHashMapSignupGET, objHashMapErrorResp);
        
        System.out.println("\nScenario1.2 - Http-POST signup actual");
        http.POST_signup_actual(objHashMapBasicUserDetails, objHashMapSignupPOST, objHashMapErrorResp);

        System.out.println("\nScenario1.3 - Http-GET activate basic account");
        http.GET_activate_basic_account(objHashMapBasicUserDetails,objHashMapActivateGET, objHashMapErrorResp);

        System.out.println("\nScenario1.4 - Http-POST signin actual");
        http.POST_signin_actual(objHashMapBasicUserDetails, objHashMapSigninPOST, objHashMapErrorResp);
        
        System.out.println("\nScenario1.5 - Http-DELETE signout basic account");
        http.DELETE_signout_basic_account(objHashMapBasicUserDetails,objHashMapSignoutDELETE, objHashMapErrorResp);        
        ...
        http.GET_basic_account_profile_detail(objHashMapBasicUserDetails,objHashMapGetAccountProfileDetailGET, objHashMapErrorResp);
        ...
        http.PUT_modify_basic_account_profile_detail(objHashMapBasicUserDetails,objHashMapModifyAccountProfileDetailPUT, objHashMapErrorResp);
        ...
        http.GET_forget_password_get_secret_question(objHashMapBasicUserDetails,objHashMapForgetPasswordGetSecretQuestionGET, objHashMapErrorResp);

        System.out.println("\nScenario3.6 - Http-PUT reset password");
        http.PUT_reset_password(objHashMapBasicUserDetails,objHashMapResetPasswordPUT, objHashMapErrorResp);
        ...
        http.GET_basic_account_profile_detail_special(objHashMapBasicUserDetails,objHashMapGetAccountProfileDetailGET, objHashMapErrorResp);

        System.out.println("\nScenario5.6 - Http-DELETE signout basic account with acceptable content type set to XML");
        http.DELETE_signout_basic_account_special(objHashMapBasicUserDetails,objHashMapSignoutDELETE, objHashMapErrorResp);
    ...
    private void GET_signup_details(HashMap<String,Object> objHashMapSignupGETTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        // make connection
        con.setRequestMethod(objHashMapSignupGETTemp.get("str_signup_GET_method").toString());
        if(! setup_Connection_General(con)){return;}
        
        // >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
        
        // response handling
        int responseCode                     = con.getResponseCode();
        String strContentTypeOfResponse     = con.getContentType();
        ...
        if (responseCode >= 400 && responseCode < 500 ){
            ...
            jsonobject                 = parse_Response_Error(con);
    ...
    private void POST_signup_actual(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapSignupPOSTTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        con.setRequestMethod(objHashMapSignupPOSTTemp.get("str_signup_POST_method").toString());
        if(! setup_Connection_POST(con)){return;}
    ...
    private void GET_activate_basic_account(HashMap<String,Object> objHashMapBasicUserDetailsTemp,HashMap<String,Object> objHashMapActivateGET, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        // make connection
        HttpURLConnection con     = (HttpURLConnection) obj.openConnection();
        con.setRequestMethod(objHashMapActivateGET.get("str_activate_GET_method").toString());
        if(! setup_Connection_General(con)){return;}
    ...
    private void POST_signin_actual(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapSigninPOSTTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        con.setRequestMethod(objHashMapSigninPOSTTemp.get("str_signin_POST_method").toString());
        if(! setup_Connection_POST(con)){return;}
    ...
    private void DELETE_signout_basic_account(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapSignoutDELETETemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        con.setRequestMethod(objHashMapSignoutDELETETemp.get("str_signout_DELETE_method").toString());
        if(! setup_Connection_General(con)){return;}
    ...
    private void DELETE_signout_basic_account_special(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapSignoutDELETETemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        // make connection
        con.setRequestMethod(objHashMapSignoutDELETETemp.get("str_signout_DELETE_method").toString());
        // setup connection with acceptable response type as XML
        if(! setup_Connection_General_special(con, MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML)){return;}
        ...
        if (null == strContentTypeOfResponse){
            System.out.println("Raw response is : " + con.getResponseMessage().toString());
            return;
        }
    ...
    private void GET_basic_account_profile_detail(HashMap<String,Object> objHashMapBasicUserDetailsTemp,HashMap<String,Object> objHashMapGetAccountProfileDetailGETTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        // make connection
        HttpURLConnection con     = (HttpURLConnection) obj.openConnection();
        con.setRequestMethod(objHashMapGetAccountProfileDetailGETTemp.get("str_getaccountprofiledetail_GET_method").toString());
        if(! setup_Connection_General(con)){return;}
    ...
    private void GET_basic_account_profile_detail_special(HashMap<String,Object> objHashMapBasicUserDetailsTemp,HashMap<String,Object> objHashMapGetAccountProfileDetailGETTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        HttpURLConnection con     = (HttpURLConnection) obj.openConnection();
        con.setRequestMethod(objHashMapGetAccountProfileDetailGETTemp.get("str_getaccountprofiledetail_GET_method").toString());
        // setup connection with content type as XML
        if(! setup_Connection_General_special(con, MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON)){return;}
    ...
    private void PUT_modify_basic_account_profile_detail(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapModifyAccountProfileDetailPUTTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        con.setRequestMethod(objHashMapModifyAccountProfileDetailPUTTemp.get("str_modifyaccountprofiledetail_PUT_method").toString());
        if(! setup_Connection_POST(con)){return;}
    ...
    private void GET_forget_password_get_secret_question(HashMap<String,Object> objHashMapBasicUserDetailsTemp,HashMap<String,Object> objHashMapForgetPasswordGetSecretQuestionGETTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        // make connection
        HttpURLConnection con     = (HttpURLConnection) obj.openConnection();
        con.setRequestMethod(objHashMapForgetPasswordGetSecretQuestionGETTemp.get("str_forgetpasswordgetsecretquestion_GET_method").toString());
        if(! setup_Connection_General(con)){return;}
    ...
    private void PUT_reset_password(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapResetPasswordPUTTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        con.setRequestMethod(objHashMapResetPasswordPUTTemp.get("str_resetpassword_PUT_method").toString());
        if(! setup_Connection_POST(con)){return;}
    ...
    private boolean setup_Connection_General(HttpURLConnection conTemp){
        ...
        try {conTemp.connect();}
        catch (ConnectException e){System.out.println("Web application is not running.");return false;}
        catch (Exception e){System.out.println("Unable to connet to web application. Following exception during hitting URL" + e.getClass().getCanonicalName());return false;}
        return true;
    }
    
    private boolean setup_Connection_General_special(HttpURLConnection conTemp, String mediatypeContent, String mediatypeResponse){
        conTemp.setRequestProperty("Content-Type", mediatypeContent);
        conTemp.setRequestProperty("Accept", mediatypeResponse);
        conTemp.setReadTimeout(10*1000);
        conTemp.setConnectTimeout(10*1000);
        conTemp.setDoOutput(true);
        try {conTemp.connect();}
    ...
    private boolean setup_Connection_POST(HttpURLConnection conTemp){
        // below line is changed from setup_Connection_General method, form param needs to in application/x-www-form-urlencoded format
        conTemp.setRequestProperty("Content-Type", MediaType.APPLICATION_FORM_URLENCODED);
        conTemp.setRequestProperty("Accept", MediaType.APPLICATION_JSON);
        conTemp.setReadTimeout(10*1000);
        conTemp.setConnectTimeout(10*1000);
        conTemp.setDoOutput(true);
    ...
    private JSONObject parse_Response(HttpURLConnection objConTemp) throws Exception{
        // parsing the response and json conversion
    ...
    private JSONObject parse_Response_Error(HttpURLConnection objConTemp) throws Exception{
        // parsing the response and json conversion
        BufferedReader in         = new BufferedReader(new InputStreamReader(objConTemp.getErrorStream()));
        String inputLine        = "";
        StringBuffer response     = new StringBuffer();
