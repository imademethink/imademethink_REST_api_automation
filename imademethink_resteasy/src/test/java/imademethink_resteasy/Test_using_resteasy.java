...
public class Test_using_resteasy {
	...
	public static void main(String[] args) throws Exception{
        ...
        Test_using_resteasy resteasy                                     = new Test_using_resteasy();
        ...
        resteasy.GET_signup_details(objHashMapSignupGET, objHashMapErrorResp);
        
        System.out.println("\nScenario1.2 - Http-POST signup actual");
        resteasy.POST_signup_actual(objHashMapBasicUserDetails, objHashMapSignupPOST, objHashMapErrorResp);

        System.out.println("\nScenario1.3 - Http-GET activate basic account");
        resteasy.GET_activate_basic_account(objHashMapBasicUserDetails,objHashMapActivateGET, objHashMapErrorResp);

        System.out.println("\nScenario1.4 - Http-POST signin actual");
        resteasy.POST_signin_actual(objHashMapBasicUserDetails, objHashMapSigninPOST, objHashMapErrorResp);
        
        System.out.println("\nScenario1.5 - Http-DELETE signout basic account");
        resteasy.DELETE_signout_basic_account(objHashMapBasicUserDetails,objHashMapSignoutDELETE, objHashMapErrorResp);
        ...
        resteasy.GET_basic_account_profile_detail(objHashMapBasicUserDetails,objHashMapGetAccountProfileDetailGET, objHashMapErrorResp);
        ...
        resteasy.PUT_modify_basic_account_profile_detail(objHashMapBasicUserDetails,objHashMapModifyAccountProfileDetailPUT, objHashMapErrorResp);
        ...
        resteasy.GET_forget_password_get_secret_question(objHashMapBasicUserDetails,objHashMapForgetPasswordGetSecretQuestionGET, objHashMapErrorResp);

        System.out.println("\nScenario3.6 - Http-PUT reset password");
        resteasy.PUT_reset_password(objHashMapBasicUserDetails,objHashMapResetPasswordPUT, objHashMapErrorResp);
        ...
        resteasy.GET_basic_account_profile_detail_special(objHashMapBasicUserDetails,objHashMapGetAccountProfileDetailGET, objHashMapErrorResp);
        System.out.println("\n\n\n\n\n\n\nScenario5.5 - This is currently not working using REST easy client \n\n\n\n\n\n");

        System.out.println("\nScenario5.6 - Http-DELETE signout basic account with acceptable content type set to XML");
        resteasy.DELETE_signout_basic_account_special(objHashMapBasicUserDetails,objHashMapSignoutDELETE, objHashMapErrorResp);
        System.out.println("\n\n\n\n\n\n\nScenario5.6 - This is currently not working using REST easy client \n\n\n\n\n\n");
    ...
    private void GET_signup_details(HashMap<String,Object> objHashMapSignupGETTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        String strContentTypeOfResponse     = response.getMediaType().toString();
    ...
    private void POST_signup_actual(HashMap<String,Object> objHashMapBasicUserDetailsTemp, HashMap<String,Object> objHashMapSignupPOSTTemp, HashMap<String,Object> objHashMapErrorRespTemp) throws Exception {
        ...
        // call method
		Response response          = null;
        try {response = target.request().post(Entity.entity(postDataBytes,MediaType.APPLICATION_FORM_URLENCODED));}
        catch (ProcessingException e){System.out.println("Web application is not running.");return;}
        catch (Exception e1){System.out.println("Unknown exception while invoking this request."); e1.printStackTrace(); return;}
    ...
    private ResteasyWebTarget setup_Connection_General(String urlTemp){
		ResteasyClient resteasyclient         = new ResteasyClientBuilder().build();
		ResteasyWebTarget resteasywebtarget   = resteasyclient.target(urlTemp);
		resteasywebtarget.request().header("Content-Type", MediaType.APPLICATION_JSON);
		resteasywebtarget.request().header("Accept", MediaType.APPLICATION_JSON);
		resteasywebtarget.request().accept(MediaType.APPLICATION_JSON);

		return resteasywebtarget;
    }
    
    private ResteasyWebTarget setup_Connection_General_special(String urlTemp, String mediatypeContent, String mediatypeResponse){
		ResteasyClient resteasyclient         = new ResteasyClientBuilder().build();
		ResteasyWebTarget resteasywebtarget   = resteasyclient.target(urlTemp);
		resteasywebtarget.request().header("Content-Type", mediatypeContent);
		resteasywebtarget.request().header("Accept", mediatypeResponse);
		resteasywebtarget.request().accept(mediatypeResponse);
		
		return resteasywebtarget;
    }
    
    private ResteasyWebTarget setup_Connection_POST(String urlTemp){
		ResteasyClient resteasyclient         = new ResteasyClientBuilder().build();
		ResteasyWebTarget resteasywebtarget   = resteasyclient.target(urlTemp);
